...
- 入力/検索: ページ内検索、テキスト貼り付け or タイプ入力
...
## 提供ツールの概要
- ナビゲーション: `chrome_navigate`, `chrome_get_url`, `chrome_get_title`
- スクリーンショット: `chrome_screenshot`, `chrome_full_screenshot`
- コンテンツ取得: `chrome_get_page_text`, `chrome_get_page_source`
- 入力/検索: `chrome_type_text`, `chrome_find_text`
- スクロール: `chrome_scroll`
